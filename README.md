...
Gratis en console.groq.com. Configurarla en el notebook:
```python
...
🛠️ Stack
Herramienta	Rol
LangGraph	Orquestación del agente como grafo de nodos
Groq	Inferencia LLM de alta velocidad
LangChain Core	Tipos de mensajes y abstracciones
